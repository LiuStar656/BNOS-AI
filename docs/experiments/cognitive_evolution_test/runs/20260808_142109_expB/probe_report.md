...
- run_dir：`E:\杂项\BNOS_AI_project\docs\experiments\cognitive_evolution_test\runs\20260808_142109_expB`
- 模型：deepseek-v4-flash  temperature=0.7
- 输入：2 条（POOL_NEUTRAL） × 1 采样 × 4 组
...
|---|---|---|---|---|---|
| warmth | 0.85 | 0.5 | -0.350 | +0.000 | 0.112 |
| playfulness | 0.5 | 0.5 | +0.000 | +0.000 | 1.0 |
| directness | 0.5 | 0.5 | +0.000 | +0.000 | 1.0 |
| curiosity | 0.675 | 0.5 | -0.175 | -1.000 | 0.3865 |

### C_low vs C_high（方法敏感性）

| 维度 | low均值 | high均值 | Δ | Cohen's d | p |
|---|---|---|---|---|---|
| warmth | 0.5 | 0.675 | +0.175 | +1.000 | 0.3865 |
| playfulness | 0.5 | 0.5 | +0.000 | +0.000 | 1.0 |
| directness | 0.5 | 0.5 | +0.000 | +0.000 | 1.0 |
| curiosity | 0.5 | 0.5 | +0.000 | +0.000 | 1.0 |

## 四、同向性

| 维度 | 向量Δ | 输出Δ | 同向 |
|---|---|---|---|
| warmth | +0.024 | -0.350 | False |
| playfulness | +0.003 | +0.000 | None |
| directness | +0.094 | +0.000 | None |
| curiosity | +0.100 | -0.175 | False |
